               ...
               if(isset($_SESSION['nickname'])&& isset($_SESSION['nickname_temp'])){
                         

                         if(($_SESSION['nickname'] == $_SESSION['nickname_temp']))
                         {
               ...
               <a href="WEB_EMP_LOGIN.php">Module Employees?</a></span>
               <IMG SRC="resource/images/india.jpg" WIDTH="100%" HEIGHT=180 BORDER=2 ALT="Bank Of India">
               
               </div>
               <div class="modal-body">
               <form class="form col-md-12 center-block" action="php/WEB_CUS_LOGIN.php" method="post" name="contact_form">
               ...
               ?>
               <input type="text" class="form-control input-lg"  name= "nickname"  id="exampleInputEmail3" maxlength='50' required placeholder="Username">
               </div>
               <div class="form-group">
               <input type="password" name="pass" class="form-control input-lg"  id="exampleInputPassword3" maxlength='50' required placeholder="Password">
               ...
               <a href="customer/WEB_CUS_FORGOTPASS.php">Need help?</a></span>
               </div>
               </form>
               </div>
